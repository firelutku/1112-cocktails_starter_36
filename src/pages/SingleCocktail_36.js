...
import Loading from '../components/Loading_36';
import { useParams, Link } from 'react-router-dom';
const url = 'https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=';

const SingleCocktail_36 = () => {
  const {id} = useParams();
  ...
  const getCocktail = async () => {
    ...
    try{
      ...
      if(drinks){
       const {strDrink: name, strDrinkThumb: image, strAlcoholic: info, setCategory: category, strGlass: glass, strInstructions: instructions,strIngredient1, strIngredient2,strIngredient3,strIngredient4,strIngredient5,} = drinks[0];
       const ingredients = [strIngredient1, strIngredient2,strIngredient3,strIngredient4,strIngredient5,];
       const newCocktails = {name, image, info, category, glass, ingredients};
...
export default SingleCocktail_36;
